...
cl = LINETCR.LINE() #Mr. Z
cl.login(qr=True)
cl.loginResult()

ki = LINETCR.LINE() #Mr. D
ki.login(qr=True)
ki.loginResult()

kk = LINETCR.LINE() #Mr. E
kk.login(qr=True)
kk.loginResult()

kc = LINETCR.LINE() #Mr. N
kc.login(qr=True)
kc.loginResult()

ks = LINETCR.LINE() #Reborn
ks.login(qr=True)
ks.loginResult()
...
mid = cl.getProfile().mid #Mr. Z
Amid = ki.getProfile().mid #Mr. D
Bmid = kk.getProfile().mid #Mr. E
Cmid = kc.getProfile().mid #Mr. N
Dmid = ks.getProfile().mid #Reborn

Bots=[mid,Amid,Bmid,Cmid,Dmid]
admin=["u5fa2d872fb1efff785968d793230dab9"] 
owner=["u5fa2d872fb1efff785968d793230dab9"]
whitelist=[""]
wait = {
    'contact':False,
    'autoJoin':True,
...
Idline: http://line.me/ti/p/~zhenmechanical""",
    "lang":"JP",
...
def bot(op):
    try:
        ...
        if op.type == 11:
          if wait["Protectgr"] == True:
            if cl.getGroup(op.param1).preventJoinByTicket == True:
              ...
              if op.param2 in admin:
                ...
                try:
                  cl.sendText(op.param1,cl.getContact(op.param2).displayName + "Jangan Buka Kode QR Njiirr")
                  cl.kickoutFromGroup(op.param1,[op.param2])
                  X = cl.getGroup(op.param1)
                  X.preventJoinByTicket = True
                  cl.updateGroup(X)
                except:
                  random.choice(KAC).sendText(op.param1,random.choice(KAC).getContact(op.param2).displayName + "Jangan Buka Kode QR Njiirr")
            ...
            if op.param3 in mid:
              if op.param2 not in Bots or admin:
                try:
                  ...
                  G = random.choice(KAC).getGroup(op.param1) #Mr. E
                  random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
                  G.preventJoinByTicket = False
    ...
    #-----------------=Selesai=------------------
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in admin:
            ...
            elif msg.text in ["Wkwkwk","wkwkwk","wkwk..."]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "100",
                ...
                ki.sendMessage(msg)
                kk.sendMessage(msg)
            elif msg.text in ["Hehehe","hehehe","hehe..."]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "10",
                ...
                ki.sendMessage(msg)
                kk.sendMessage(msg)
            elif msg.text in ["Hmmm","hmmm","hmm..."]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "101",
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Join all","Join kuy"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Tag All Finish---------------#
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
            ...
            elif "Ready" in msg.text:
              if msg.from_ in owner:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Ready","")
                    gs = cl.getGroup(msg.to)
                    gs = ki.getGroup(msg.to)
                    gs = kk.getGroup(msg.to)
                    gs = kc.getGroup(msg.to)
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Bot out"]: # Keluar Dari Semua Group Yang Di dalem nya  ada bot(Kalo Bot Kalian Nyangkut di Group lain :D)
              if msg.from_ in owner:
                gid = cl.getGroupIdsJoined()
...
#-----------------------------------------------
      ...
      #-------------Fungsi Balesan Respon Start---------------------#
			...
			elif msg.text in ["Lu kenapa?"]:
				kc.sendText(msg.to,"Sange")
			elif msg.text in ["Apaan?"]:
				ki.sendText(msg.to, "??? 􀨁􀅴questioning􏿿")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'u5fa2d872fb1efff785968d793230dab9'}
              cl.sendText(msg.to,"======================")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
